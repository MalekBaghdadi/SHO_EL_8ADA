...
const mockFoods: Food[] = [
  { id: 1, name: "Burger", category: "Fast Food", tags: ["meat", "heavy"], attributes: {} },
  { id: 2, name: "Salad", category: "Healthy", tags: ["vegan", "light"], attributes: {} },
  { id: 3, name: "Pizza", category: "Fast Food", tags: ["vegetarian", "heavy"], attributes: {} },
];
...
console.log(`Selected: ${result1.selectedFood?.name}`);
...
console.log(`Selected: ${result2.selectedFood?.name} (ID: ${result2.selectedFood?.id})`);
...
const singleFood: Food[] = [{ id: 1, name: "Only Food", category: "Test", tags: ["test"], attributes: {} }];
...
console.log(`Selected: ${result3.selectedFood?.name}`);
...
for (let i = 0; i < 10; i++) {
  ...
  console.log(`Selection ${i + 1}: ${result.selectedFood?.name} (Excluded: ${result.debug.excludedLastFood})`);
